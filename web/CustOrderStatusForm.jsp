    ...
    <body>
        ...
        <table border="1" align="center" style="border-collapse: collapse">
            ...
            <%
                ...
                java.util.List<pack.OrderBean> list = pack.OrderBean.getRecords("select * from ordermaster where customer_id='"+customerid+"' order by order_date desc,order_id");
            ...
            <tr>
                ...
                <td>
                    <form method="post" action="OrderStatusProcess.jsp" >
                        ...
                        {
                        %>
                            <input type="submit" value="Cancel sOrder" >
                        <%
                        }
                        %>
